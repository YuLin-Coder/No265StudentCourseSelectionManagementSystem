...
public class TijiaozuoyeController {
    ...
    public R page(@RequestParam Map<String, Object> params,TijiaozuoyeEntity tijiaozuoye,
		...
		if(tableName.equals("jiaoshi")) {
			tijiaozuoye.setGonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<TijiaozuoyeEntity> wrapper = new EntityWrapper<TijiaozuoyeEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = tijiaozuoyeService.selectCount(wrapper);
