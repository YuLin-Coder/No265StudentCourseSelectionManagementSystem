<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成绩名称" prop="chengjimingcheng">
          <el-input v-model="ruleForm.chengjimingcheng" 
              placeholder="成绩名称" clearable  :readonly="ro.chengjimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成绩名称" prop="chengjimingcheng">
              <el-input v-model="ruleForm.chengjimingcheng" 
                placeholder="成绩名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评价建议" prop="pingjiajianyi">
          <el-input v-model="ruleForm.pingjiajianyi" 
              placeholder="评价建议" clearable  :readonly="ro.pingjiajianyi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评价建议" prop="pingjiajianyi">
              <el-input v-model="ruleForm.pingjiajianyi" 
                placeholder="评价建议" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	xueshengxingming : false,
      ...
      rules: {
          ...
          chengjimingcheng: [
                { required: true, message: '成绩名称不能为空', trigger: 'blur' },
          ],
          fenshu: [
  ...
  created() {
	this.ruleForm.fasongriqi = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengmingcheng = true;
          ...
          if(o=='chengjimingcheng'){
            this.ruleForm.chengjimingcheng = obj[o];
	    this.ro.chengjimingcheng = true;
            continue;
          }
          if(o=='fenshu'){
