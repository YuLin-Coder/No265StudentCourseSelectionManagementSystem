<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选课备注" prop="xuankebeizhu">
          <el-input v-model="ruleForm.xuankebeizhu" 
              placeholder="选课备注" clearable  :readonly="ro.xuankebeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选课备注" prop="xuankebeizhu">
              <el-input v-model="ruleForm.xuankebeizhu" 
                placeholder="选课备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xuankeshijian = true;
          ...
          if(o=='xuankebeizhu'){
            this.ruleForm.xuankebeizhu = obj[o];
	    this.ro.xuankebeizhu = true;
            continue;
          }
          if(o=='xuehao'){
