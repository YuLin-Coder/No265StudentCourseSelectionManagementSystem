<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.tijiaoneirong" label="提交内容" prop="tijiaoneirong">
          <file-upload
          tip="点击上传提交内容"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.tijiaoneirong?ruleForm.tijiaoneirong:''"
          @change="tijiaoneirongUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.tijiaoneirong" label="提交内容" prop="tijiaoneirong">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.tijiaoneirong)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	if(this.ruleForm.tijiaoneirong!=null) {
		this.ruleForm.tijiaoneirong = this.ruleForm.tijiaoneirong.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    tijiaoneirongUploadChange(fileUrls) {
	this.ruleForm.tijiaoneirong = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
